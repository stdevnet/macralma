...
export default function Catalogo() {
  ...
  /*
   * Esta clave cambia cada vez que cambia un filtro.
   * Esto permite reiniciar la animación de entrada de los productos.
   */
    ...
    <main className="min-h-screen bg-[#FAF7F2]">
      ...
      <section className="bg-[#E8D8C3]">
        <div className="mx-auto max-w-6xl px-6 py-20 text-center md:py-24">
          <p className="mb-5 text-sm uppercase tracking-[0.25em] text-[#756B60] md:text-base">
            Nuestra colección
          </p>

          <h1 className="text-5xl font-bold tracking-tight text-[#29251F] md:text-6xl">
            Nuestro catálogo
          </h1>

          <p className="mx-auto mt-6 max-w-2xl text-lg leading-relaxed text-[#756B60] md:text-xl">
