...
export default function Catalogo() {
  ...
  const claveAnimacion = `${tipo}-${orden}-${tallasSeleccionadas.join(",")}-${medidasSeleccionadas.join(",")}-${coloresSeleccionados.join(",")}`;
  return (
    <main className="min-h-screen bg-[#FAF7F2]">
      ...
      >
        {" "}
        {/* Overlay */} <div className="absolute inset-0 bg-[#29251F]/55"></div>{" "}
        {/* Contenido */}{" "}
      ...
      <section className="mx-auto max-w-7xl px-6 py-20 md:py-24">
        ...
        <div className="flex flex-col gap-10 md:flex-row">
          ...
          {/* FILTROS */}{" "}
          <aside
            className={`w-full shrink-0 md:block md:w-64 ${mostrarFiltros ? "block" : "hidden"}`}
          >
            {" "}
              ...
              <div className="border-b border-[#E8DED1] pb-6">
                ...
                <div className="space-y-3">
                  ...
                  <label className="flex cursor-pointer items-center gap-3 text-sm text-[#29251F]">
                    ...
                    />{" "}
                    <span
                      className={`flex h-5 w-5 items-center justify-center rounded-full border ${tipo === "todos" ? "border-[#29251F]" : "border-[#CDBCA7]"}`}
                    >
                      {" "}
                      {tipo === "todos" && (
                  ...
                  <label className="flex cursor-pointer items-center gap-3 text-sm text-[#29251F]">
                    ...
                    />{" "}
                    <span
                      className={`flex h-5 w-5 items-center justify-center rounded-full border ${tipo === "prendas" ? "border-[#29251F]" : "border-[#CDBCA7]"}`}
                    >
                      {" "}
                      {tipo === "prendas" && (
                        <span className="h-2.5 w-2.5 rounded-full bg-[#29251F]" />
                  ...
                  <div>
                    ...
                    >
                      ...
                      <span className="flex items-center gap-3">
                        {" "}
                        <span
                          className={`flex h-5 w-5 items-center justify-center rounded-full border ${tipo === "mascotas-prendas" || tipo === "mascotas-accesorios" ? "border-[#29251F]" : "border-[#CDBCA7]"}`}
                        >
                          {" "}
                      ...
                      <span
                        className={`text-xs transition-transform duration-300 ${mascotasAbierto ? "rotate-180" : ""}`}
                      >
                        {" "}
                        ↓{" "}
                      </span>{" "}
                    ...
                    {/* SUBMENÚ MASCOTAS */}{" "}
                    <div
                      className={`ml-8 grid overflow-hidden transition-all duration-300 ${mascotasAbierto ? "mt-3 grid-rows-[1fr] opacity-100" : "grid-rows-[0fr] opacity-0"}`}
                    >
                      {" "}
                      <div className="min-h-0 space-y-3 border-l border-[#E8DED1] pl-4">
                        ...
                        <label className="flex cursor-pointer items-center gap-3 text-sm text-[#756B60] transition-colors hover:text-[#29251F]">
                          ...
                          />{" "}
                          <span
                            className={`flex h-4 w-4 items-center justify-center rounded-full border ${tipo === "mascotas-prendas" ? "border-[#29251F]" : "border-[#CDBCA7]"}`}
                          >
                            {" "}
                            {tipo === "mascotas-prendas" && (
                        ...
                        <label className="flex cursor-pointer items-center gap-3 text-sm text-[#756B60] transition-colors hover:text-[#29251F]">
                          ...
                          />{" "}
                          <span
                            className={`flex h-4 w-4 items-center justify-center rounded-full border ${tipo === "mascotas-accesorios" ? "border-[#29251F]" : "border-[#CDBCA7]"}`}
                          >
                            {" "}
                            {tipo === "mascotas-accesorios" && (
                              <span className="h-2 w-2 rounded-full bg-[#29251F]" />
                  ...
                  <label className="flex cursor-pointer items-center gap-3 text-sm text-[#29251F]">
                    ...
                    />{" "}
                    <span
                      className={`flex h-5 w-5 items-center justify-center rounded-full border ${tipo === "adornos" ? "border-[#29251F]" : "border-[#CDBCA7]"}`}
                    >
                      {" "}
                      {tipo === "adornos" && (
                        <span className="h-2.5 w-2.5 rounded-full bg-[#29251F]" />
              ...
              <div className="border-b border-[#E8DED1] py-6">
                ...
                <div className="space-y-3">
                  ...
                  <label className="flex cursor-pointer items-center gap-3 text-sm text-[#29251F]">
                    ...
                    />{" "}
                    <span
                      className={`flex h-5 w-5 items-center justify-center rounded-full border ${orden === "" ? "border-[#29251F]" : "border-[#CDBCA7]"}`}
                    >
                      {" "}
                      {orden === "" && (
                        <span className="h-2.5 w-2.5 rounded-full bg-[#29251F]" />
                  ...
                  <label className="flex cursor-pointer items-center gap-3 text-sm text-[#29251F]">
                    ...
                    />{" "}
                    <span
                      className={`flex h-5 w-5 items-center justify-center rounded-full border ${orden === "menor" ? "border-[#29251F]" : "border-[#CDBCA7]"}`}
                    >
                      {" "}
                      {orden === "menor" && (
                        <span className="h-2.5 w-2.5 rounded-full bg-[#29251F]" />
                  ...
                  <label className="flex cursor-pointer items-center gap-3 text-sm text-[#29251F]">
                    ...
                    />{" "}
                    <span
                      className={`flex h-5 w-5 items-center justify-center rounded-full border ${orden === "mayor" ? "border-[#29251F]" : "border-[#CDBCA7]"}`}
                    >
                      {" "}
                      {orden === "mayor" && (
                        <span className="h-2.5 w-2.5 rounded-full bg-[#29251F]" />
                  ...
                  <div className="space-y-3">
                    ...
                    {tallasDisponibles.map((talla) => (
                      ...
                      >
                        ...
                        />{" "}
                        <span
                          className={`flex h-5 w-5 items-center justify-center rounded border ${tallasSeleccionadas.includes(talla) ? "border-[#29251F] bg-[#29251F]" : "border-[#CDBCA7]"}`}
                        >
                          {" "}
                  ...
                  <div className="space-y-3">
                    ...
                    {medidasDisponibles.map((medida) => (
                      ...
                      >
                        ...
                        />{" "}
                        <span
                          className={`flex h-5 w-5 items-center justify-center rounded border ${medidasSeleccionadas.includes(medida) ? "border-[#29251F] bg-[#29251F]" : "border-[#CDBCA7]"}`}
                        >
                          {" "}
                  ...
                  <div className="space-y-3">
                    ...
                    {coloresDisponibles.map((color) => (
                      ...
                      >
                        ...
                        />{" "}
                        <span
                          className={`flex h-5 w-5 items-center justify-center rounded border ${coloresSeleccionados.includes(color) ? "border-[#29251F] bg-[#29251F]" : "border-[#CDBCA7]"}`}
                        >
                          {" "}
            ...
            {!cargando && !error && productosFiltrados.length === 0 && (
              <div className="rounded-2xl border border-[#E8DED1] bg-white px-6 py-16 text-center shadow-sm">
                ...
                <p className="mx-auto mt-3 max-w-md text-[#756B60]">
                  {" "}
                  Prueba a cambiar los filtros para encontrar otros
                  productos.{" "}
                </p>{" "}
              </div>
            )}{" "}
